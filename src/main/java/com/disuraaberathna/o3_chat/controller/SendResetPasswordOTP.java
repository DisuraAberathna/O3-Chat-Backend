...
@WebServlet(name = "SendResetPasswordOTP", urlPatterns = {"/send-reset-otp"})
public class SendResetPasswordOTP extends HttpServlet {
            ...
            try (Session session = HibernateUtil.getSessionFactory().openSession()) {
                ...
                if (user != null) {
                    ...
                    Thread mailSender = new Thread(() -> {
                        ...
                        Mail.sendMail(user.getEmail(), "Password Reset Verification - O3 Chat", content);
                    });
                    mailSender.start();
                    ...
                    responseObject.addProperty("msg", "OTP sent successfully!");
                } else {
